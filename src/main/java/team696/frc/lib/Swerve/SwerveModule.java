...
public class SwerveModule {
    ...
    public SwerveModule(int moduleNumber, SwerveModuleConstants moduleConstants){
        ...
        _encoder = new CANcoder(moduleConstants.CANcoderId, "drive");
        _encoder.getConfigurator().apply(SwerveConfigs.canCoder);

        /* Angle Motor Config */
        _angleMotor = new TalonFactory(moduleConstants.SteerMotorId, "drive", SwerveConfigs.angle, "Swerve Angle " + moduleNumber);
        resetToAbsolute();

        /* Drive Motor Config */
        _driveMotor = new TalonFactory(moduleConstants.DriveMotorId, "drive", SwerveConfigs.drive, "Swerve Drive " + moduleNumber);
